    ...
    <div class="min-h-screen bg-stone-50 py-8">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="mb-8">
                ...
                <p class="text-stone-500">Update the marketplace specifications, inventory settings, and host producer profile data.</p>
            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input type="text" name="name" id="name-input" value="{{ old('name', $product->name) }}" required 
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="slug" id="slug-input" value="{{ old('slug', $product->slug) }}" readonly required 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <select name="status" class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 appearance-none transition">
                                            <option value="active" {{ old('status', $product->status) == 'active' ? 'selected' : '' }}>Active (Visible on Site)</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="featured" class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 appearance-none transition">
                                            <option value="0" {{ old('featured', $product->featured) == 0 ? 'selected' : '' }}>Standard Marketplace Listing</option>
                                            <option value="1" {{ old('featured', $product->featured) == 1 ? 'selected' : '' }}>Showcase on Homepage Spotlight</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="bg-white p-6 md:p-8 rounded-3xl border border-stone-200 shadow-sm space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="producer_name" value="{{ old('producer_name', $product->producer_name) }}" required 
                                       class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 transition">
                            </div>
                                ...
                                <div class="col-span-1">
                                    ...
                                    <select name="ward_number" class="w-full px-3 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 transition">
                                        @foreach(range(1,4) as $w)
                                            <option value="{{ $w }}" {{ old('ward_number', $product->ward_number) == $w ? 'selected' : '' }}>W-{{ $w }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-span-2">
                                    <label class="block text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1.5">Village Settlement</label>
                                    <input type="text" name="village_name" value="{{ old('village_name', $product->village_name) }}" required 
                            ...
                            <div>
                                ...
                                <input type="url" name="contact_link" value="{{ old('contact_link', $product->contact_link) }}" placeholder="https://" 
                                       class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 transition">
                            </div>
                            ...
                            <div>
                                ...
                                <div id="preview-container" class="{{ $product->image ? '' : 'hidden' }} mt-4 rounded-xl overflow-hidden border border-stone-200 bg-stone-50 shadow-inner">
