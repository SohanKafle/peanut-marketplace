        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 grid lg:grid-cols-2 gap-12 items-center">
            <div class="space-y-6 text-center lg:text-left">
                ...
                <p class="text-sm sm:text-base text-peanut/80 max-w-lg mx-auto lg:mx-0 leading-relaxed font-light">
                    Sourced directly from indigenous women's cooperatives near Pokhara. We connect hand-harvested organic fields to urban homes.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                    <a href="/peanuts" class="inline-flex justify-center items-center px-6 py-3.5 bg-peanut text-cream text-xs font-bold uppercase tracking-wider rounded-xl hover:bg-peanut-light transition-all duration-300 shadow-sm">
                        Explore Marketplace
                    </a>
                    <a href="#story" class="inline-flex justify-center items-center px-6 py-3.5 border border-peanut text-peanut text-xs font-bold uppercase tracking-wider rounded-xl hover:bg-yellow-100 transition-colors">
                        Watch Our Story
                    </a>
                </div>
            </div>
            
            <div class="relative w-full aspect-[6/5] bg-cream-dark overflow-hidden flex items-center justify-center rounded-3xl border border-cream-dark shadow-sm">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left order-1 lg:order-2 space-y-5">
                    ...
                    <p class="text-xs sm:text-sm text-peanut/80 leading-relaxed font-light">
                        Experience local community-led homestays, witness traditional mountain lifestyles, and explore organic peanut setups nestled near the Annapurna foothills. We bridge the direct path between our growers and health-conscious buyers.
                    </p>
                    
                    <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-1">
                        <a href="/homestays" class="bg-peanut text-white text-center font-bold uppercase tracking-wider px-5 py-3 rounded-xl text-xs hover:bg-peanut-light transition shadow-sm">
                            Explore Homestays
                        </a>
                        <a href="/about" class="border border-peanut text-peanut text-center font-bold uppercase tracking-wider px-5 py-3 rounded-xl text-xs hover:bg-yellow-100 transition">
                            Meet Our Farmers
                        </a>
                    </div>

                    <p class="text-[11px] text-peanut/50 italic leading-snug pt-1">
                        * Note: Instant booking and marketplace orders sync directly into our neighborhood Facebook and Instagram chat platforms.
                    </p>
                </div>
