                                    ...
                                    <div>
                                        ...
                                        <select name="status"
                                            ...
                                            <option value="inactive"
                                                {{ old('status') == 'inactive' ? 'selected' : '' }}>Inactive (Hidden)
                                            </option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="featured"
                                            class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 appearance-none transition">
                                            <option value="0" {{ old('featured') == 0 ? 'selected' : '' }}>Standard
                                                Marketplace Listing</option>
                                            <option value="1" {{ old('featured') == 1 ? 'selected' : '' }}>Showcase
                                                on Homepage Spotlight</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div class="bg-white p-6 md:p-8 rounded-3xl border border-stone-200 shadow-sm space-y-5">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div class="col-span-1">
                                    ...
                                    <select name="ward_number"
                                        ...
                                        @foreach (range(1, 4) as $w)
                                            <option value="{{ $w }}"
                                                {{ old('ward_number') == $w ? 'selected' : '' }}>W-{{ $w }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="village_name"
                                        value="{{ old('village_name', 'Ghachok') }}" required
                                        class="w-full px-3 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 transition">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="url" name="contact_link" value="{{ old('contact_link') }}"
                                    placeholder="https://"
                                    class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800 transition">
                            </div>
                            ...
                            <div>
                                ...
                                <div id="preview-container"
                                    class="hidden mt-4 rounded-xl overflow-hidden border border-stone-200 bg-stone-50 shadow-inner">
