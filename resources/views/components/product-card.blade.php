...
<a href="{{ route('marketplace.show', $product->slug) }}" class="group block">
    <div class="aspect-[4/5] bg-peanut-100 overflow-hidden relative mb-4">
        ...
        <div class="absolute inset-x-0 bottom-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex justify-center items-end">
            <span class="text-xs font-medium bg-cream text-forest px-4 py-2 uppercase tracking-widest shadow-soft">View Details</span>
        </div>
    </div>
