        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($homestays as $homestay)
                    <div class="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition flex flex-col group">
                        ...
                        <div class="p-6 flex-grow flex flex-col justify-between">
                            ...
                            <div class="mt-auto grid grid-cols-2 gap-2">
                                ...
                                <a href="https://wa.me/{{ $homestay->whatsapp_number ?? 'YOUR_PHONE_NUMBER' }}?text={{ urlencode('Hello, I am interested in booking: ' . $homestay->name) }}" target="_blank" 
                                   class="flex items-center justify-center gap-1.5 w-full bg-[#25D366] hover:bg-[#20bd5a] text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider py-3 rounded-xl transition shadow-sm" title="Book via WhatsApp">
                                ...
                                <a href="{{ $homestay->facebook_url ?? 'https://m.me/your-facebook-page' }}" target="_blank" 
                                   class="flex items-center justify-center gap-1.5 w-full bg-[#0084FF] hover:bg-[#0073e6] text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider py-3 rounded-xl transition shadow-sm" title="Book via Messenger">
                                    <svg class="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24">
