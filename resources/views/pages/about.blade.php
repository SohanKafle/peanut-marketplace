        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div class="bg-white border border-cream-dark p-8 md:p-10 rounded-2xl shadow-sm hover:shadow-md transition duration-300">
                    ...
                    <h3 class="font-serif text-2xl font-bold text-peanut mb-4">Our Mission</h3>
                    <p class="text-sm md:text-base text-peanut/70 leading-relaxed">
                        To advance economic resilience by linking rural organic outputs with active market centers using digital tools that the community fully owns and operates.
                    </p>
                </div>
                <div class="bg-white border border-cream-dark p-8 md:p-10 rounded-2xl shadow-sm hover:shadow-md transition duration-300">
                    <span class="text-xs font-bold uppercase tracking-widest text-golden block mb-2">The Future</span>
                    <h3 class="font-serif text-2xl font-bold text-peanut mb-4">Our Vision</h3>
                    <p class="text-sm md:text-base text-peanut/70 leading-relaxed">
                        Establishing a replicable village model where traditional agricultural value streams and responsive, authentic ecotourism co-exist smoothly.
                    </p>
                </div>
            </div>

            <div class="bg-white border border-cream-dark p-8 md:p-12 rounded-2xl shadow-sm">
                <div class="text-center mb-8">
                    <h3 class="font-serif text-2xl md:text-3xl font-bold text-peanut mb-3">Where to Find Us</h3>
                    <p class="text-sm md:text-base text-peanut/80">Machapuchhre Municipality, near the hub of Pokhara, Gandaki Province.</p>
                </div>
                
                <div class="w-full h-64 md:h-96 bg-cream border border-cream-dark rounded-xl flex flex-col items-center justify-center text-peanut/50">
                    <svg class="w-10 h-10 mb-3 text-golden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                    </svg>
                    <span class="text-xs font-bold uppercase tracking-wider">Interactive Map Integration Loading...</span>
                </div>
            </div>
