<x-app-layout>
    <div class="min-h-screen bg-stone-50 py-8">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <form action="{{ route('admin.homestays.update', $homestay->id) }}" method="POST"
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label
                                        ...
                                        Name</label>
                                    <input type="text" name="name" value="{{ $homestay->name }}" required
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        <label
                                            ...
                                            Name</label>
                                        <input type="text" name="host_name" value="{{ $homestay->host_name }}"
                                            required
                                            class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800">
                                    </div>
                                    <div>
                                        ...
                                        <input type="text" name="location" value="{{ $homestay->location }}" required
                                            class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        <label
                                            ...
                                            Capacity</label>
                                        <input type="number" name="capacity" value="{{ $homestay->capacity }}" required
                                            class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800">
                                    </div>
                                    <div>
                                        <label
                                        ...
                                        <input type="number" name="price_per_night"
                                            value="{{ $homestay->price_per_night }}" required
                                            class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800">
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <textarea name="description" rows="5"
                                        class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800">{{ $homestay->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white p-6 md:p-8 rounded-3xl border border-stone-200 shadow-sm space-y-5">
                            ...
                            <div>
                                <label
                                    ...
                                    URL</label>
                                <input type="url" name="contact_url" value="{{ $homestay->contact_url }}"
                                    class="w-full px-4 py-3 bg-white border border-stone-300 rounded-xl focus:border-peanut outline-none text-stone-800">
                            </div>
                            <div>
                                <label
                                    class="block text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1.5">Change
                                    Image</label>
                                <input type="file" name="image" id="image-input"
                                    class="w-full text-sm text-stone-500">
                                @if ($homestay->image_path)
                                    <div id="existing-image"
                                        class="mt-4 rounded-xl overflow-hidden border border-stone-200">
                                        <img src="{{ asset('storage/' . $homestay->image_path) }}"
