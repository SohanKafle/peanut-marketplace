<x-public-layout title="Connect & Support | Peanut Marketplace">
    ...
    <section class="bg-peanut text-cream py-16 md:py-24 border-b-4 border-golden">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="font-serif text-4xl md:text-6xl font-bold text-white mb-6">Connect & Support.</h1>
            <p class="text-sm md:text-base text-cream/80 leading-relaxed max-w-2xl mx-auto">
                Whether you're looking to source our organic harvests, collaborate on digital scaling, or simply learn more about our village model, we want to hear from you.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 md:py-20 bg-cream">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="bg-white p-8 md:p-10 rounded-2xl border border-cream-dark shadow-sm">
                    <h2 class="font-serif text-2xl font-bold text-peanut mb-6">Direct Inquiries</h2>
                    <div class="space-y-6">
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-peanut/80">Machapuchhre Municipality, Kaski, Nepal.</p>
                        </div>
                        <div>
