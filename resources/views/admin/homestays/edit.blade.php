<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-serif font-bold text-stone-900">Edit Property</h1>
                ...
                <div class="bg-white p-6 md:p-8 rounded-3xl border border-stone-200 shadow-sm">
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ $homestay->name }}" required class="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:border-peanut outline-none">
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label class="block text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1.5">Host Name</label>
                                <input type="text" name="host_name" value="{{ $homestay->host_name }}" required class="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:border-peanut outline-none">
                            </div>
                            <div>
                                <label class="block text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1.5">Location</label>
                                <input type="text" name="location" value="{{ $homestay->location }}" required class="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:border-peanut outline-none">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="number" name="capacity" value="{{ $homestay->capacity }}" required class="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:border-peanut outline-none">
                            </div>
                            <div>
                                <label class="block text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1.5">Price (NPR/Night)</label>
                                <input type="number" name="price_per_night" value="{{ $homestay->price_per_night }}" required class="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:border-peanut outline-none">
                            </div>
                        </div>

                        <div>
                            <label class="block text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1.5">Description</label>
                            <textarea name="description" rows="5" class="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:border-peanut outline-none">{{ $homestay->description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white p-6 md:p-8 rounded-3xl border border-stone-200 shadow-sm space-y-5">
                    ...
                    <div>
                        ...
                        <input type="url" name="contact_url" value="{{ $homestay->contact_url }}" class="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-xl focus:border-peanut outline-none">
                    </div>
                ...
                <div class="flex items-center gap-4 pt-4">
                    ...
                    <button type="submit" class="flex-[2] py-4 bg-peanut text-white font-bold rounded-xl hover:bg-stone-900 transition shadow-lg">Update Property</button>
                </div>
            </div>
        </form>
    </div>
