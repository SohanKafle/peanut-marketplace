    ...
    <header class="bg-white/95 backdrop-blur-md sticky top-0 z-50 border-b border-cream-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
            ...
            <nav class="hidden lg:flex items-center gap-8 font-medium text-xs tracking-wider uppercase">
                <a href="/" @class([
                    'transition py-1 border-b-2',
                    'text-peanut border-golden font-semibold' => request()->is('/'),
                    'text-peanut/80 border-transparent hover:text-peanut hover:border-golden' => !request()->is('/')
                ])>Home</a>
                
                <a href="/about" @class([
                    'transition py-1 border-b-2',
                    'text-peanut border-golden font-semibold' => request()->is('about*'),
                    'text-peanut/80 border-transparent hover:text-peanut hover:border-golden' => !request()->is('about*')
                ])>About</a>
                
                <a href="/peanuts" @class([
                    'transition py-1 border-b-2',
                    'text-peanut border-golden font-semibold' => request()->is('peanuts*'),
                    'text-peanut/80 border-transparent hover:text-peanut hover:border-golden' => !request()->is('peanuts*')
                ])>Peanuts</a>
                
                <a href="/homestays" @class([
                    'transition py-1 border-b-2',
                    'text-peanut border-golden font-semibold' => request()->is('homestays*'),
                    'text-peanut/80 border-transparent hover:text-peanut hover:border-golden' => !request()->is('homestays*')
                ])>Homestays</a>
                
                <a href="/stories" @class([
                    'transition py-1 border-b-2',
                    'text-peanut border-golden font-semibold' => request()->is('stories*'),
                    'text-peanut/80 border-transparent hover:text-peanut hover:border-golden' => !request()->is('stories*')
                ])>Stories</a>
            </nav>
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-white border-t border-cream-dark shadow-xl absolute w-full left-0 z-50">
            <div class="px-4 pt-3 pb-6 space-y-1.5">
                ...
                <div class="pt-4 mt-2 border-t border-cream-dark">
                    <a href="/connect" class="w-full text-center block bg-peanut text-white font-semibold py-3.5 rounded-xl text-sm transition hover:bg-peanut-light">
                        Connect & Support
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left mb-12">
                <div>
                    ...
                    <p class="text-cream/70 text-sm max-w-sm mx-auto md:mx-0 leading-relaxed font-light">
                ...
                <div class="border-t border-white/10 md:border-0 pt-8 md:pt-0">
                    ...
                    <ul class="space-y-3 text-sm font-medium text-cream/80">
                        <li><a href="/peanuts" class="hover:text-white block py-1 transition-colors">Local Peanuts Section</a></li>
                        <li><a href="/homestays" class="hover:text-white block py-1 transition-colors">Community Homestays</a></li>
                        <li><a href="/stories" class="hover:text-white block py-1 transition-colors">Blogs & Conversations</a></li>
                    </ul>
                </div>
                <div class="border-t border-white/10 md:border-0 pt-8 md:pt-0">
                    <h4 class="text-golden font-bold uppercase tracking-wider text-xs mb-4">Contact Gateway</h4>
                    <p class="text-sm text-cream/80 mb-4 font-light">Machapuchhre Municipality, Kaski, Nepal.</p>
