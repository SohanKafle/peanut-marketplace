<x-app-layout>
    <div class="min-h-screen bg-stone-50 py-8">
        <div class="max-w-5xl mx-auto px-4">
            <div class="mb-8">
                <h1 class="text-3xl font-serif font-bold text-stone-900">Edit Story</h1>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white border border-stone-200 rounded-2xl p-6 shadow-sm">
                            ...
                            @if($story->image_path)
                                <div id="existing-image" class="mb-4 rounded-xl overflow-hidden border border-stone-200">
                                    <img src="{{ asset('storage/'.$story->image_path) }}" class="w-full aspect-video object-cover">
                                </div>
                            @endif
                            ...
                            <div class="relative aspect-video rounded-xl bg-stone-50 border-2 border-dashed border-stone-300 flex items-center justify-center cursor-pointer overflow-hidden group hover:border-peanut transition">
                                ...
                                <span id="upload-label" class="text-[10px] font-bold text-stone-400 uppercase group-hover:text-peanut">Change Image</span>
                            </div>
                        </div>
