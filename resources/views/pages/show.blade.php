<x-public-layout title="Story Details | Ghachok Community">
    <div class="max-w-4xl mx-auto px-6 py-20">
        ...
        <a href="{{ route('stories.index') }}"
            class="text-stone-400 hover:text-peanut text-xs font-bold uppercase tracking-widest mb-6 block">&larr; Back
            to Stories</a>
        ...
        @if ($story->image_path)
            <img src="{{ asset('storage/' . $story->image_path) }}" alt="{{ $story->title }}"
                class="w-full aspect-video object-cover rounded-3xl mb-10 shadow-lg">
        @endif
